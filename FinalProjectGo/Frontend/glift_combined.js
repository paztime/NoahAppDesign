 ...
 * --------------------------------------
 */
$.getScript("go_client.js", function(){
  console.log("go_client loaded and executed.");
});
...
glift.widgets.options.STANDARD_PROBLEM = {
  stoneClick: function(event, widget, pt) {
    ...
    */
    console.log(pt +"   "+ currentPlayer);
    var sgf_point = pt.toSgfCoord();
    console.log(sgf_point +"   "+ currentPlayer);
    playerMoved(sgf_point, currentPlayer);
  },
